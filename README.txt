...
2) If you install Wildfly you will have jet the "rest_easy" API so I've set this dependency as provided.

3) Create the war using Maven: mvn clean package (or install if you want to install It in the maven repository).

4) Deploy the war and run the following URL: 
	
	http://localhost:8080/JAX-RS-rest-service/rest/contact/1234

5) The result has to be something like that:
